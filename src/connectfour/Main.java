...
public class Main extends Application
{
    ...
    private void aboutMe()
    {
        ...
        alert.setHeaderText("Prabuddha Kumar");
        alert.setContentText("Hi! I am Prabuddha, a developer focused on crafting" +
                ...
                " intuitive and functional applications & websites. Being an Engineering student" +
                " I believe in using science to find creative practical solutions." +
                " My other hobbies includes Coding, Reading, Cooking & Painting.");
